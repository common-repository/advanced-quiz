...
class WpAdvQuiz_Controller_GlobalSettings extends WpAdvQuiz_Controller_Controller
{
    ...
    private function edit()
    {
		...
		//Summary
			...
			$practice_btn_width = $this->_post['practice_btn_width'];
			$practice_btn_width = $mapper->CheckForButtonDefaults('practice_btn_width',$practice_btn_width);
			
			if (add_option('wpAdvQuiz_practice_btn_width', $practice_btn_width, '', 'no') === false) {
                update_option('wpAdvQuiz_practice_btn_width', $practice_btn_width);
            }
			
			$practice_btn_height = $this->_post['practice_btn_height'];
			$practice_btn_height = $mapper->CheckForButtonDefaults('practice_btn_height',$practice_btn_height);
			
			if (add_option('wpAdvQuiz_practice_btn_height', $practice_btn_height, '', 'no') === false) {
                update_option('wpAdvQuiz_practice_btn_height', $practice_btn_height);
            }
			
			$practice_btn_color = $this->_post['practice_btn_color'];
			$practice_btn_color = $mapper->CheckForButtonDefaults('practice_btn_color',$practice_btn_color);
			
			if (add_option('wpAdvQuiz_practice_btn_color', $practice_btn_color, '', 'no') === false) {
                update_option('wpAdvQuiz_practice_btn_color', $practice_btn_color);
            }
			...
			$clear_btn_width = $this->_post['clear_btn_width'];
			$clear_btn_width = $mapper->CheckForButtonDefaults('clear_btn_width',$clear_btn_width);
			
			if (add_option('wpAdvQuiz_clear_btn_width', $clear_btn_width, '', 'no') === false) {
                update_option('wpAdvQuiz_clear_btn_width', $clear_btn_width);
            }
			
			$clear_btn_height = $this->_post['clear_btn_height'];
			$clear_btn_height = $mapper->CheckForButtonDefaults('clear_btn_height',$clear_btn_height);
			
			if (add_option('wpAdvQuiz_clear_btn_height', $clear_btn_height, '', 'no') === false) {
                update_option('wpAdvQuiz_clear_btn_height', $clear_btn_height);
            }
			
			$clear_btn_color = $this->_post['clear_btn_color'];
			$clear_btn_color = $mapper->CheckForButtonDefaults('clear_btn_color',$clear_btn_color);
			
			if (add_option('wpAdvQuiz_clear_btn_color', $clear_btn_color, '', 'no') === false) {
                update_option('wpAdvQuiz_clear_btn_color', $clear_btn_color);
            }
		...
		$view->practice_btn_width = $mapper->getButtonProperty('wpAdvQuiz_practice_btn_width');
		$view->practice_btn_height = $mapper->getButtonProperty('wpAdvQuiz_practice_btn_height');
		$view->practice_btn_color = $mapper->getButtonProperty('wpAdvQuiz_practice_btn_color');
		...
		$view->clear_btn_width = $mapper->getButtonProperty('wpAdvQuiz_clear_btn_width');
		$view->clear_btn_height = $mapper->getButtonProperty('wpAdvQuiz_clear_btn_height');
		$view->clear_btn_color = $mapper->getButtonProperty('wpAdvQuiz_clear_btn_color');
