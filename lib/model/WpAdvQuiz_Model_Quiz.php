...
class WpAdvQuiz_Model_Quiz extends WpAdvQuiz_Model_Model
{
	...
	protected $_btnClearQuizHidden = false;
	protected $_btnViewPracticeShow = false;
	...
	public function setBtnClearQuizHidden($_btnClearQuizHidden)
    {
        $this->_btnClearQuizHidden = (bool)$_btnClearQuizHidden;

        return $this;
    }
	
	public function isBtnClearQuizHidden()
    {
        return $this->_btnClearQuizHidden;
    }
	...
	public function setBtnViewPracticeShow($_btnViewPracticeShow)
    {
        $this->_btnViewPracticeShow = (bool)$_btnViewPracticeShow;
	
		return $this;
    }

    public function isBtnViewPracticeShow()
    {
		
        return $this->_btnViewPracticeShow;
    }
