...
class WpAdvQuiz_Helper_XmlQuizExporter implements WpAdvQuiz_Helper_QuizExporterInterface
{
    ...
    private function getQuizElement($dom, $quiz, $forms)
    {
		...
		$quizElement->appendChild($dom->createElement('btnClearQuizHidden',
			$this->booleanToTrueOrFalse($quiz->isBtnClearQuizHidden())));
        $quizElement->appendChild($dom->createElement('btnViewQuestionHidden',
            $this->booleanToTrueOrFalse($quiz->isBtnViewQuestionHidden())));
	    $quizElement->appendChild($dom->createElement('btnViewPracticeQuestionShow',
            $this->booleanToTrueOrFalse($quiz->isBtnViewPracticeQuestionShow())));		
