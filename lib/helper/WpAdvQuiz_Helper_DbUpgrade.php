...
class WpAdvQuiz_Helper_DbUpgrade
{
    ...
    public function databaseDelta()
    {
        ...
        dbDelta("
			...
			CREATE TABLE {$this->_wpdb->prefix}wp_adv_quiz_master (
			  ...
			  btn_clear_quiz_hidden tinyint(1) NOT NULL,
			  btn_view_question_hidden tinyint(1) NOT NULL,
			  btn_view_practice_show tinyint(1) NOT NULL,
	...
	private function upgradeDbV25()
    {
		$this->_wpdb->query('
			ALTER TABLE  `' . $this->_wpdb->prefix . 'wp_adv_quiz_master`
				ADD  `btn_clear_quiz_hidden` TINYINT( 1 ) NOT NULL AFTER  `btn_restart_quiz_hidden` ,
				ADD  `btn_view_practice_show` TINYINT( 1 ) NOT NULL AFTER  `btn_view_question_hidden`
		');
