                ...
                <div id="poststuff">
                    <div class="postbox">
                        ...
                        <div class="inside">
                            ...
                            <input name="title" class="regular-text" value="<?php 
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside">
                            <?php
							$Questionrequired = $this->question->getQuestion();
							//$Questionrequired = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $Questionrequired);
							
							$allowed_html = wp_kses_allowed_html( 'post' );
							$Questionrequired = wp_kses($Questionrequired, $allowed_html);
							
                            wp_editor($Questionrequired, "question", array('textarea_rows' => 5));
                            ?>
                        </div>
                    </div>
                    <div class="postbox"
                    ...
                    <div style="<?php echo esc_attr($this->quiz->isHideAnswerMessageBox()) ? 'display: none;' : ''; ?>">
                        <div class="postbox">
                            ...
                            <div class="inside">
								...
								$correctMsg = $this->question->getCorrectMsg();
								//$correctMsg = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $correctMsg);
								
								$allowed_html = wp_kses_allowed_html( 'post' );
								$correctMsg = wp_kses($correctMsg, $allowed_html);

                                wp_editor($correctMsg, "correctMsg", array('textarea_rows' => 3));
                                ?>
                            </div>
                        </div>
                        <div class="postbox" id="wpAdvQuiz_incorrectMassageBox">
                            ...
                            <div class="inside">
								...
								$incorrectMsg = $this->question->getIncorrectMsg();
								//$incorrectMsg = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $incorrectMsg);
								
								$allowed_html = wp_kses_allowed_html( 'post' );
								$incorrectMsg = wp_kses($incorrectMsg, $allowed_html);

                                wp_editor($incorrectMsg, "incorrectMsg",
