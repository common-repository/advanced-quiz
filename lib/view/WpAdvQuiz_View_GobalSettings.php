			...
			<div class="inside">
				<table class="form-table" style="max-width: 800px;">
					<tbody>
						...
						<tr>
							<td>
								<p class="description"><strong><?php _e('Practice quiz', 'wp-adv-quiz'); ?></strong></p>
							</td>
							<td>
							    <input class="medium-text" name="practice_btn_width" style="width: 100px; text-align:center;" value="<?php echo esc_attr($this->practice_btn_width); ?>">
							</td>
							
							<td>
							    <input class="medium-text" name="practice_btn_height" style="width: 100px; text-align:center;"value="<?php echo esc_attr($this->practice_btn_height); ?>">
							</td >
							<td>
							    <input class="medium-text" name="practice_btn_color" style="width: 100px; text-align:center;"value="<?php echo esc_attr($this->practice_btn_color); ?>">
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<p class="description"><strong><?php _e('Clear', 'wp-adv-quiz'); ?></strong></p>
							</td>
							<td>
							    <input class="medium-text" name="clear_btn_width" style="width: 100px; text-align:center;" value="<?php echo esc_attr($this->clear_btn_width); ?>">
							</td>
							
							<td>
							    <input class="medium-text" name="clear_btn_height" style="width: 100px; text-align:center;"value="<?php echo esc_attr($this->clear_btn_height); ?>">
							</td >
							<td>
							    <input class="medium-text" name="clear_btn_color" style="width: 100px; text-align:center;"value="<?php echo esc_attr($this->clear_btn_color); ?>">
							</td>
						</tr>
						<tr>
							<td>
