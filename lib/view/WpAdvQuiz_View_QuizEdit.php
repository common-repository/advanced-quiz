...
class WpAdvQuiz_View_QuizEdit extends WpAdvQuiz_View_View
{
        ...
        <div class="postbox">
            ...
            <div class="inside">
                <table class="form-table">
					...
					<tr>
                        <th scope="row">
                            <?php _e('Hide "Clear question" button', 'wp-adv-quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Hide "Clear question" button', 'wp-adv-quiz'); ?></span>
                                </legend>
                                <label for="btn_clear_quiz_hidden">
                                    <input type="checkbox" id="btn_clear_quiz_hidden" value="1"
                                           name="btnClearQuizHidden" <?php echo esc_attr($this->quiz->isBtnClearQuizHidden()) ? 'checked="checked"' : '' ?> >
                                    <?php _e('Activate', 'wp-adv-quiz'); ?>
                                </label>
							
                                <p class="description">
                                    <?php _e('Hide the "Clear question" button in the Frontend.',
                                        'wp-adv-quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
					...
					<tr>
                        <th scope="row">
                            <?php _e('Display practice button', 'wp-adv-quiz'); ?>
                        </th>
                        <td>
                            <fieldset>
                                <legend class="screen-reader-text">
                                    <span><?php _e('Display practice button', 'wp-adv-quiz'); ?></span>
                                </legend>
                                <label for="btn_view_practice_show">
                                    <input type="checkbox" id="btn_view_practice_show" value="1"
                                           name="btnViewPracticeShow" <?php echo esc_attr($this->quiz->isBtnViewPracticeShow()) ? 'checked="checked"' : '' ?> >
								...
								<p class="description">
                                    <?php _e('Show a  button in the Frontend to check the results on runtime.',
                                        'wp-adv-quiz'); ?>
                                </p>
                            </fieldset>
                        </td>
                        ...
                        <ul id="resultList">
                            ...
                            for ($i = 0; $i < 15; $i++) {
                                ...
                                if ($this->quiz->isResultGradeEnabled() && isset($resultText['text'][$i])) {
									...
									$resultTextContent = wp_kses($resultText['text'][$i], $allowed_html);
									
                                    ?>
                                    <li style="padding: 5px; border: 1px dotted;">
                                        <div
                                                style="margin-bottom: 5px;"><?php wp_editor($resultTextContent,
                                                'resultText_' . $i, array(
                                                    'textarea_rows' => 3,
    ...
    {
		$postBoxTitle = $this->quiz->getName();
		//$postBoxTitle = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $postBoxTitle);
		
		$postBoxTitle = sanitize_text_field($postBoxTitle);
        ?>
        <div class="postbox">
            ...
            <div class="inside">
                <input name="name" id="wpAdvQuiz_title" type="text" class="regular-text"
                       value="<?php echo htmlspecialchars($postBoxTitle, ENT_QUOTES); ?>">
            </div>
        </div>
        <?php
    }
    ...
    private function postBoxQuizDescription()
    {
		...
		//$postBoxQuizDescription = preg_replace('#<script(.*?)>(.*?)</script>#is', '', $postBoxQuizDescription);
		
		$allowed_html = wp_kses_allowed_html( 'post' );
		$postBoxQuizDescription = wp_kses($postBoxQuizDescription, $allowed_html);
        ...
        <div class="postbox">
            ...
            <div class="inside">
                ...
                <?php
                wp_editor($postBoxQuizDescription, "text");
                ?>
            </div>
        </div>
        <?php
